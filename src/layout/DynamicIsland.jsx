  ...
  if (isLearning) {
    return {
      vars: {
        ...
        '--topbar-active': 'linear-gradient(90deg, #2f6fed, #13a38b, #d15d34)',
        '--topbar-active-shadow': '0 0 12px rgba(47, 111, 237, 0.24)',
  ...
  if (pathname.startsWith('/finance') || pathname.startsWith('/books')) {
    return {
      vars: {
        ...
        '--topbar-active': 'linear-gradient(90deg, #d7b56d, #4c9769)',
        '--topbar-active-shadow': '0 0 12px rgba(215, 181, 109, 0.36)',
  ...
  if (pathname.startsWith('/logic')) {
    return {
      vars: {
        ...
        '--topbar-active': 'linear-gradient(90deg, #b89a54, #c24a3e)',
        '--topbar-active-shadow': '0 0 12px rgba(184, 154, 84, 0.36)',
